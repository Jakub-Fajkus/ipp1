...
echo " test02: Jednoduchy SELECT element FROM ROOT; Expected output: test02.out; Expected return code: 0"
...
echo " test03: Vyber pomoci SELECT je omezen na dve polozky - soucasne byla odstranena hlavicka; Expected output: test03.out; Expected return code: 0"
...
echo " test04: Vypsani pouze prazdneho Rootu pomoci omezeni limitu na 0; Expected output: test04.out; Expected return code: 0"
...
echo " test05: SELECT element z nasobneho nodu; Expected output: test05.out; Expected return code: 0"
...
echo " test06: Vyber elementu z podelementu prvniho vyskytu prohledavaneho elementu 'library' s attributem 'my'; Expected output: test06.out; Expected return code: 0"
...
echo " test07: Vyber z prvniho elementu obsahujiciho attribut 'my'; Expected output: test07.out; Expected return code: 0"
...
echo " test08: SELECT s jednoduchou podminkou; Expected output: test08.out; Expected return code: 0"
...
echo " test09: dalsi SELECT s jednoduchou podminkou; Expected output: test09.out; Expected return code: 0"
...
echo " test10: SELECT s chybnou podminkou; Expected output: test10.out; Expected return code: 80"
...
echo " test11: osetreni parametru; Expected output: test11.out; Expected return code: 1"
echo "$INTERPRETER $TASK.$EXTENSION --input=${LOCAL_IN_PATH}test11.in --output=${LOCAL_OUT_PATH}test11.out --qf=${LOCAL_OUT_PATH}test11.out --query='SELECT book FROM catalog' 2> ${LOG_PATH}test11.err"
